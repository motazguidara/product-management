...
public class SpringJpaApplication2 {
    ...
    public static void main(String[] args) {
        ...
        // Trois objets de type LocalDate
        LocalDate date1 = LocalDate.parse("2021-04-15", formatter);
        LocalDate date2 = LocalDate.parse("2022-02-20", formatter);
        LocalDate date3 = LocalDate.parse("2023-01-10", formatter);
        LocalDate date4 = LocalDate.parse("2023-05-15", formatter);
        LocalDate dateFinPromotion = LocalDate.parse("2023-01-01", formatter);
